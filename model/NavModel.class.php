<?php
	...
	class NavModel extends model{
		...
		public function getFrontNav(){
			$_sql="SELECT id,nav_name,nav_info
						  FROM  cms_nav 
						  WHERE pid=0
						  ORDER BY sort ASC
						  LIMIT 0,".NAV_SIZE;
		...
		//查询单个
		public function getOneNav(){
			$_sql="SELECT n1.id,n1.nav_name,n1.nav_info,
						  n2.id iid,n2.nav_name nnav_name
						  FROM cms_nav n1
		...
		public function getAllNav(){
			$_sql="SELECT id,nav_name,nav_info,sort
						  FROM  cms_nav 
						  WHERE pid=0
						  ORDER BY sort ASC
						$this->limit";
